<template>
  <div class="p-4">
    ...
    <div v-if="movieStore.loading">Carregando...</div>
    <div v-else-if="movieStore.error" class="text-red-600">{{ movieStore.error }}</div>

    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
      <div v-for="movie in movieStore.movies" :key="movie.imdbID" class="border rounded p-4 flex flex-col items-center text-center">
